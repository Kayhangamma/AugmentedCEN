...
def main():
    ...
    filename = "./files/expertiseDist.csv"
    ...
    fig, ax = plt.subplots()
    rects1 = ax.bar(ind, vector2, width, color='indigo')
    ...
    ax.set_ylabel('Average Time to Respond (Normalized by SLT)')
    ...
    #ax.legend((rects1[0]), ('Empirical Probability of TRSs with Repeating Experts (given TRS Frequency)'), loc='upper center', bbox_to_anchor=(0.53, 1.00), fancybox=True, shadow=True, ncol=1, prop={'size':20})
